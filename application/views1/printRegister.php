		...
		<div class="layout">
			<div class="row">
				...
				<p class="p-20 centered">
					Your admission is not confirmed in Sartaj Coaching. You have to submit this printout to institute and take approval of admission than you will be eligible for online test paper of Sartaj Coaching. And other facilities of Sartaj Coaching Institute (Sartaj Coaching). 
				</p>
				<?php endif;?>
